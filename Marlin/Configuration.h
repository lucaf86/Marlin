...
//#define STRING_CONFIG_H_AUTHOR "(Luca)" // Who made the changes.
...
//#define MAG_MOUNTED_PROBE
  ...
  #define PROBE_DEPLOY_FEEDRATE (83*60)  // (mm/min) Probe deploy speed
  #define PROBE_STOW_FEEDRATE   (83*60)  // (mm/min) Probe stow speed

  #define MAG_MOUNTED_DEPLOY_1 { PROBE_DEPLOY_FEEDRATE, { 100, 100, 50 } }  // Move to side Dock & Attach probe
  //#define MAG_MOUNTED_DEPLOY_2 { PROBE_DEPLOY_FEEDRATE, { 210, 114, 30 } }  // Move probe off dock
  //#define MAG_MOUNTED_DEPLOY_3 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  //#define MAG_MOUNTED_DEPLOY_4 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  //#define MAG_MOUNTED_DEPLOY_5 { PROBE_DEPLOY_FEEDRATE, {   0,   0,  0 } }  // Extra move if needed
  #define MAG_MOUNTED_STOW_1   { PROBE_STOW_FEEDRATE,   { 100, 100, 50 } }  // Move to dock
...
#define DISABLE_M504_EEPROM_VALIDATE // disables M504 G-code 
