...
//
  ...
  #include "sanguino/pins_MELZI_MALYAN.h"           // ATmega644P, ATmega1284P              env:sanguino1284p_optimized env:sanguino1284p env:sanguino644p env:melzi_optiboot_optimized env:melzi_optiboot env:melzi_optimized env:melzi
